  ...
  <div class="grid">
    <main>
      ...
      <section class="card">
        ...
        <div class="notes">
          <textarea id="sharedNotes" placeholder="Appunti condivisi..."></textarea>
        </div>
        ...
        <div class="small">Chi riceve il link vedrà il contenuto incollato nell'area note.</div>
      </section>
      ...
      <section class="card">
        ...
        <div class="small">I file sono salvati nel browser come DataURL.</div>
      </section>
    </main>
    ...
    <aside>
      ...
      <section class="card">
        <h3>Piccole magie</h3>
        <p class="muted">Premi "Invia" nella chat per risposte automatiche.</p>
...
<div id="chatContainer">
  <section class="card">
    ...
    <div class="small">La chat è locale e resta sul browser.</div>
  </section>
</div>
...
document.getElementById('pwReset').addEventListener('click', ()=>{ 
  if(confirm('Reset locale (cancella tutte le note e documenti)?')){ 
    localStorage.clear(); 
    alert('Locale resettato. Ricarica la pagina.'); 
  }
});
